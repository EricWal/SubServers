			...
			if (args[0].equalsIgnoreCase("start")) {
                ...
                if (args.length == 3) {
                    if (!(SubPlugin.SubServers.contains(args[1]) || args[1].equalsIgnoreCase("~Lobby"))) {
                        ...
                        if (sender instanceof Player) {
                            ((Player) sender).sendMessage(ChatColor.RED + SubPlugin.lprefix + SubPlugin.lang.getString("Lang.Commands.Teleport-Proxy-Error"));
                        } else {
                            Bukkit.getLogger().info(String.valueOf(SubPlugin.lprefix) + SubPlugin.lang.getString("Lang.Commands.Teleport-Proxy-Error"));
                        }
                    } else {
                        ...
                        if (sender instanceof Player) {
                            ((Player) sender).sendMessage(ChatColor.AQUA + SubPlugin.lprefix + SubPlugin.lang.getString("Lang.Commands.Teleport"));
                        } else {
                            Bukkit.getLogger().info(String.valueOf(SubPlugin.lprefix) + SubPlugin.lang.getString("Lang.Commands.Teleport"));
                        }
                    }
